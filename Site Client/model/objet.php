...
class objet {
    ...
    public static function getOne($id) {
        ...
        if ($resultat) {
            // Utilisez un switch pour déterminer le type d'objet à créer
            switch ($classeRecuperee) {
                case 'Pizza':
                    return new Pizza(
                    ...
                    break;
                case 'Autre_Produit':
                    return new Autre_Produit(
                        $resultat['id_produit'] ?? null,
                        $resultat['nom_produit'] ?? null,
                        $resultat['description_produit'] ?? null,
                        $resultat['prix_produit'] ?? null,
                        $resultat['id_stock_produit'] ?? null
                    );
                    break;
